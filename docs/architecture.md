...
> Generated by `hexaqual deps graph`. Diagrams show internal module structure and third-party dependencies. Regenerate with `uv run hexaqual deps graph`; CI enforces freshness.
